      ...
      <div className="h-[100vh]">
        <div className="flex-col-1 flex flex-wrap-reverse justify-between">
          <div className="">
            ...
            <h5 className="py-1 text-[#868585]">
              I&apos;m a <span className="bg-[#464649] text-gray-100 px-1 py-[0.15rem]">Fullstack Developer</span> and <span className="bg-[#464649] px-1 py-[0.15rem] text-gray-100">Designer</span>
            </h5>
          </div>
          ...
          <div className="ht-[9rem] w-[6rem] dark:bg-[#18181B] bg-white dark:bg-grid-white/[0.2] bg-grid-[#18181B] relative flex items-center justify-center">
            ...
            <Image src="/images/mypic.png" className="w-16 h-16" alt="soumenBhunia" width={64} height={64} />
          </div>
        </div>
